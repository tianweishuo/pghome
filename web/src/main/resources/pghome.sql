...
create table driver_register(
	...
	driving_date DATE not null comment '初次领取驾照日期',
	car_umber varchar(10) not null comment '车牌号',
	car_model varchar(10) not null comment '车型',
	car_color varchar(10) not null comment '车辆颜色',
  car_name varchar(10) not null comment '车辆所有人',
  car_register_date DATE not null comment '车辆注册日期',
  status smallint(5) not null comment '审核状态 0-审核中，1-审核失败 ，2-审核成功',
